...
public class SpecialMoves {
    ...
    public List<EnPassantMove> getEnPassantMoveIfPossible(List<Move> moves, Piece[][] matrix, PositionDto actualPosition, PieceColor turn){
        /*
        ...
        * */
        ...
        if (piece != null && piece.getColor() == turn ){
            ...
            for (int i = 0;i<2;i++){
                ...
                if (enemyPawn != null && enemyPawn.getClass().getSimpleName().equals("Peon")  && enemyPawn.getColor() != turn && matrix[actualPosition.getX()+x][actualPosition.getY()+y] == null){ // IF THERE IS AN ENEMY PAWN WHO HAS A FREE SPACE BEHIND IT THEN WE HACE EN PASSANT
